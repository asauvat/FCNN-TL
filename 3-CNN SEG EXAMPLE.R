...
#LOAD MODEL
#=================================================================================================================================================================#
tr.dir = getwd() #Trained models & functions location
#
source(paste0(tr.dir,'/FUNCS/dice_metrics.R')) 
modsem = unet::unet(input_shape = c(sF,sF,1),num_classes = 2,filters=32,num_layers = 3)%>%load_model_weights_hdf5(paste0(tr.dir,'/H5/tl512d-ncm.h5')) #model import
#-------------------#
